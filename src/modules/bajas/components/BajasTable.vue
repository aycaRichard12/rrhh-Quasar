...
import { obtenerColumnasBajas } from '../utils/bajas.columns';

import { normalizarTipoMotivo } from 'src/modules/motivosdebaja/utils/motivosDeBaja.columns';


const { t } = useI18n();
const listaColumnas = computed(() => obtenerColumnasBajas(t));
...
} = useFiltroExcel(() => props.listaBajas, configuracionFiltros);
</script>