...
export const obtenerColumnasTiposDeContratos = (t: (key: string) => string): QTableColumn<TipoDeContrato>[] => [
  ...
  {name: 'nombre',     label: t('tiposdecontratos.name'),       align: 'left',  field: 'nombre',     style: 'width: 153px; white-space: normal'},
  {name: 'observacion',label: t('tiposdecontratos.observation'),align: 'left',  field: 'observacion',style: 'min-width:210px; white-space: normal'},
  {name: 'naturaleza', label: t('tiposdecontratos.nature'),     align: 'left',  field: 'naturaleza', style: 'min-width:210px; white-space: normal'},
