    ...
    >
      ...
      <template #body-cell-opciones="propsCell">
        <q-td :props="propsCell">
          ...
          >
            <q-tooltip anchor="top middle" self="bottom middle" :offset="[10, 10]">{{ $t('metodosdeevaluacion.range.manage') }}</q-tooltip>
          </q-btn>
        </q-td>
      </template>
    </TablaGenerica>
...
const emits = defineEmits<{
  ...
  (e: 'gestionarRangos', metodo: MetodoDeEvaluacion): void;
