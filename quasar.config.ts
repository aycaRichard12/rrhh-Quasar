...
export default defineConfig((/* ctx */) => {
  return {
    ...
    boot: ['axios', 'dark-mode', 'i18n', 'apexcharts'],
    ...
    pwa: {
      ...
      // Nombre del service worker que generará Workbox
      ...
      // Ensure the generated client entry registers our SW helper in production
      pwaRegisterServiceWorker: true,
